...
int main(int argc, const char* const argv[]) {
    const auto component_list = userver::components::MinimalServerComponentList()
                                    ...
                                    .Append<chat::handlers::chat::SocketManager>()
                                    .Append<chat::app::Application>()
                                    .Append<chat::handlers::auth::AuthHandler>()
                                    .Append<chat::app::registry::RegistryComponent>()
                                    .Append<chat::app::auth::AuthComponent>()
                                    .Append<userver::components::Postgres>("chat-database")
                                    // Testuite components:
